...
`contracts.py`. They represent business label, multiple active alerts, latest
active alert and complete event history without free-form exception text. The
existing GUI/backend runtime does not yet consume these DTOs; production UI and
backend integration remain a separately reviewed follow-on.
